                    ...
                    try {
                        ...
                        videosAdaptor.setOnItemClickListener(new VideosAdaptor.OnItemClickListener() {
                            ...
                            public void onItemClick(int position, String key) {
                                //GpAuCG6iUcA
                                VideoModel VModel = list.get(position);
                                String modelKey = VModel.getKey();
                                Intent youtubeIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("vnd.youtube://" + modelKey));


                                Intent webIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=" + modelKey));
